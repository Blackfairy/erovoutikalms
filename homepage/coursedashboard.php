...
<body>
<!--NAVIGATION MENU-->
    <nav class="navbar navbar-dark navbar-expand-lg py-0 fixed-top" style="background-color:#0205a1;">
        <a href="https://eira.erovoutika.ph/index.php" class="navbar-brand text-center">
        ...
        <div class="collapse navbar-collapse bg-transparent">
            <div class="navbar-nav ms-auto mx-xl-auto">
                ...
                <a href="/homepage/enroll.php" class="nav-item">Register</a>
            </div>
        </div>
    </nav>
...
<main>
                ...
                <!--FRONT END DEVELOPMENT COURSES-->
                    <div class="dialog col position-relative text-center">
                        <div class="d-inline-block">
                            <img src="/homepage/img/course.png" alt="img" style="height:150px; width:260px; padding-top: 10px;">
                                    ...
                                    <!--HTML COURSE-->
                                        <div class="tab-pane container" id="html">
                                            ...
                                            <div class="button-width">
                                                <div class="btn m-2"><a href="/homepage/html.html">Start Learning</a></div>
                                            </div>
                                        </div>
                                    <!--CSS COURSE-->
                                        <div class="tab-pane container" id="css">
                                            ...
                                            <div class="button-width">
                                                <div class="btn m-2"><a href="/homepage/css.html">Start Learning</a></div>
                                            </div>
                                        </div>
                                    <!--JAVASCRIPT COURSE-->
                                        <div class="tab-pane container" id="javascript">
                                            ...
                                            <div class="button-width">
                                                <div class="btn m-2"><a href="/homepage/javascript.html">Start Learning</a></div>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <a class="popup__close" href="#"><i class="fa-regular fa-circle-xmark"></i></a>
                                    ...
                                    <!--PHP COURSE-->
                                        <div class="tab-pane container" id="php">
                                            ...
                                            <div class="button-width">
                                                <div class="btn m-2"><a href="/homepage/php.html">Start Learning</a></div>
                                            </div>
                                        </div>
                                    </div>
                            </div>
    ...
    <!--GALLERY-->
        <section>
            <div class="container-fluid mt-5 border-top project py-5">
                <div class="container">
